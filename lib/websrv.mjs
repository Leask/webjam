...
import { utilitas, dbio, email, color, encryption, tape } from 'utilitas';
import * as auth from './identity.mjs';
import * as file from './file.mjs';
import * as robot from './robot.mjs';
import * as router from './router.mjs';
import * as service from './service.mjs';
import * as splunk from './splunk.mjs';
...
const rawInit = async (options, callback) => {
    ...
    if (options.bot) { await robot.init(options); }
    ...
    if (options.splunk) { await splunk.init(options.splunk); }
