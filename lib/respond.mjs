...
const act = async (object_class, object_id, respond_type, respond_value, created_by) => {
    ...
    return await dbio.upsert(table, {
        id: await newId(), object_class, object_id, respond_type, created_by,
...
const queryByClassAndCreator = async (object_class, object_id, created_by, options) =>
    await dbio.queryByKeyValue(table, { object_class, object_id, created_by });
