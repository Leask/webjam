...
const initSql = {
    ...
    [dbio.POSTGRESQL]: [[
        ...
        `CREATE INDEX IF NOT EXISTS ${table}_provider_index ON ${table} (provider)`,
    ], [
        `CREATE INDEX IF NOT EXISTS ${table}_account_index ON ${table} (account)`,
    ], [
        `CREATE INDEX IF NOT EXISTS ${table}_user_id_index ON ${table} (user_id)`,
    ], [
        `CREATE INDEX IF NOT EXISTS ${table}_username_index ON ${table} (username)`,
    ], [
        `CREATE INDEX IF NOT EXISTS ${table}_full_name_index ON ${table} (full_name)`,
    ], [
        `CREATE INDEX IF NOT EXISTS ${table}_email_index ON ${table} (email)`,
    ], [
