...
const initSql = {
    ...
    [dbio.POSTGRESQL]: [[
        ...
        `CREATE INDEX IF NOT EXISTS filename ON ${table} (filename)`,
    ], [
        `CREATE INDEX IF NOT EXISTS originalname ON ${table} (originalname)`,
    ], [
        `CREATE INDEX IF NOT EXISTS mimetype ON ${table} (mimetype)`,
    ], [
        `CREATE INDEX IF NOT EXISTS size ON ${table} (size)`,
    ], [
