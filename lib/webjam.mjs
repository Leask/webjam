import {
    callosum, color, dbio, email, encryption, manifest, network, tape, utilitas
} from 'utilitas';
...
const _init = async (options, callback) => {
    ...
    isPrimary && log(`${webjam.title} is launching...`, { time: true });
    webjam.argv = nopt();
...
const end = async () => {
    ...
    process.exit(); // @todo by @LeaskH: Should be removed. // related to utilitas
};
